...
export type ReasoningRequestMessages = {
...
export type ReasoningRequest = {
  ...
  messages: Array<ReasoningRequestMessages>;
...
/** @internal */
export const ReasoningRequestMessages$inboundSchema: z.ZodType<
...
/** @internal */
export type ReasoningRequestMessages$Outbound = {
  role?: string | undefined;
  content?: string | undefined;
};

/** @internal */
export const ReasoningRequestMessages$outboundSchema: z.ZodType<
  ReasoningRequestMessages$Outbound,
  z.ZodTypeDef,
  ReasoningRequestMessages
> = z.object({
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ReasoningRequestMessages$ {
  /** @deprecated use `ReasoningRequestMessages$inboundSchema` instead. */
  export const inboundSchema = ReasoningRequestMessages$inboundSchema;
  /** @deprecated use `ReasoningRequestMessages$outboundSchema` instead. */
  export const outboundSchema = ReasoningRequestMessages$outboundSchema;
  /** @deprecated use `ReasoningRequestMessages$Outbound` instead. */
  export type Outbound = ReasoningRequestMessages$Outbound;
}

export function reasoningRequestMessagesToJSON(
  reasoningRequestMessages: ReasoningRequestMessages,
): string {
  return JSON.stringify(
    ReasoningRequestMessages$outboundSchema.parse(reasoningRequestMessages),
  );
}

export function reasoningRequestMessagesFromJSON(
  jsonString: string,
): SafeParseResult<ReasoningRequestMessages, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ReasoningRequestMessages$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ReasoningRequestMessages' from JSON`,
  );
}
...
> = z.object({
  ...
  messages: z.array(z.lazy(() => ReasoningRequestMessages$inboundSchema)),
...
export type ReasoningRequest$Outbound = {
  model?: string | undefined;
  messages: Array<ReasoningRequestMessages$Outbound>;
  temperature: number;
  max_tokens: number;
  stream: boolean;
  top_p: number;
...
> = z.object({
  model: z.string().optional(),
  messages: z.array(z.lazy(() => ReasoningRequestMessages$outboundSchema)),
  temperature: z.number().default(0.7),
