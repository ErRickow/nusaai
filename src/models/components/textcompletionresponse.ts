...
export type TextCompletionResponseChoices = {
...
export type TextCompletionResponse = {
  ...
  choices?: Array<TextCompletionResponseChoices> | undefined;
...
/** @internal */
export const TextCompletionResponseChoices$inboundSchema: z.ZodType<
  TextCompletionResponseChoices,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export type TextCompletionResponseChoices$Outbound = {
  text?: string | undefined;
  index?: number | undefined;
  logprobs?: string | null | undefined;
...
/** @internal */
export const TextCompletionResponseChoices$outboundSchema: z.ZodType<
  TextCompletionResponseChoices$Outbound,
  z.ZodTypeDef,
  TextCompletionResponseChoices
> = z.object({
  text: z.string().optional(),
 ...
 */
export namespace TextCompletionResponseChoices$ {
  /** @deprecated use `TextCompletionResponseChoices$inboundSchema` instead. */
  export const inboundSchema = TextCompletionResponseChoices$inboundSchema;
  /** @deprecated use `TextCompletionResponseChoices$outboundSchema` instead. */
  export const outboundSchema = TextCompletionResponseChoices$outboundSchema;
  /** @deprecated use `TextCompletionResponseChoices$Outbound` instead. */
  export type Outbound = TextCompletionResponseChoices$Outbound;
}

export function textCompletionResponseChoicesToJSON(
  textCompletionResponseChoices: TextCompletionResponseChoices,
): string {
  return JSON.stringify(
    TextCompletionResponseChoices$outboundSchema.parse(
      textCompletionResponseChoices,
    ),
  );
}

export function textCompletionResponseChoicesFromJSON(
  jsonString: string,
): SafeParseResult<TextCompletionResponseChoices, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => TextCompletionResponseChoices$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'TextCompletionResponseChoices' from JSON`,
  );
}
...
> = z.object({
  ...
  choices: z.array(z.lazy(() => TextCompletionResponseChoices$inboundSchema))
    .optional(),
...
export type TextCompletionResponse$Outbound = {
  ...
  created?: number | undefined;
  model?: string | undefined;
  choices?: Array<TextCompletionResponseChoices$Outbound> | undefined;
...
> = z.object({
  ...
  created: z.number().int().optional(),
  model: z.string().optional(),
  choices: z.array(z.lazy(() => TextCompletionResponseChoices$outboundSchema))
    .optional(),
