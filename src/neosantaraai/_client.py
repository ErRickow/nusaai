...
from .resources import chat, usage, models, system, reasoning, embeddings, completions, moderations
from ._streaming import Stream as Stream, AsyncStream as AsyncStream
from ._exceptions import APIStatusError, NeosantaraError
...
class Neosantara(SyncAPIClient):
    ...
    reasoning: reasoning.ReasoningResource
    system: system.SystemResource
    with_raw_response: NeosantaraWithRawResponse
    with_streaming_response: NeosantaraWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        if base_url is None:
            base_url = os.environ.get("NEOSANTARA_BASE_URL")
        if base_url is None:
            base_url = f"https://api.neosantara.xyz/v1"
        ...
        self.reasoning = reasoning.ReasoningResource(self)
        self.system = system.SystemResource(self)
        self.with_raw_response = NeosantaraWithRawResponse(self)
        self.with_streaming_response = NeosantaraWithStreamedResponse(self)
...
class AsyncNeosantara(AsyncAPIClient):
    ...
    reasoning: reasoning.AsyncReasoningResource
    system: system.AsyncSystemResource
    with_raw_response: AsyncNeosantaraWithRawResponse
    with_streaming_response: AsyncNeosantaraWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        self.reasoning = reasoning.AsyncReasoningResource(self)
        self.system = system.AsyncSystemResource(self)
        self.with_raw_response = AsyncNeosantaraWithRawResponse(self)
        self.with_streaming_response = AsyncNeosantaraWithStreamedResponse(self)
...
class NeosantaraWithRawResponse:
    def __init__(self, client: Neosantara) -> None:
        ...
        self.reasoning = reasoning.ReasoningResourceWithRawResponse(client.reasoning)
        self.system = system.SystemResourceWithRawResponse(client.system)


class AsyncNeosantaraWithRawResponse:
    def __init__(self, client: AsyncNeosantara) -> None:
        ...
        self.reasoning = reasoning.AsyncReasoningResourceWithRawResponse(client.reasoning)
        self.system = system.AsyncSystemResourceWithRawResponse(client.system)


class NeosantaraWithStreamedResponse:
    def __init__(self, client: Neosantara) -> None:
        ...
        self.reasoning = reasoning.ReasoningResourceWithStreamingResponse(client.reasoning)
        self.system = system.SystemResourceWithStreamingResponse(client.system)


class AsyncNeosantaraWithStreamedResponse:
    def __init__(self, client: AsyncNeosantara) -> None:
        ...
        self.reasoning = reasoning.AsyncReasoningResourceWithStreamingResponse(client.reasoning)
        self.system = system.AsyncSystemResourceWithStreamingResponse(client.system)


Client = Neosantara

AsyncClient = AsyncNeosantara
