...
def _get_open_connections(client: Neosantara | AsyncNeosantara) -> int:
...
class TestNeosantara:
    client = Neosantara(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_multipart_repeating_array(self, client: Neosantara) -> None:
        request = client._build_request(
    ...
    def test_base_url_setter(self) -> None:
        client = Neosantara(base_url="https://example.com/from_init", api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(NEOSANTARA_BASE_URL="http://localhost:5000/from/env"):
            client = Neosantara(api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: Neosantara) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Neosantara) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Neosantara) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Neosantara(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Neosantara(base_url=base_url, api_key=api_key, _strict_response_validation=False)
...
class TestAsyncNeosantara:
    client = AsyncNeosantara(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_multipart_repeating_array(self, async_client: AsyncNeosantara) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(NEOSANTARA_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncNeosantara(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncNeosantara) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncNeosantara) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncNeosantara) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncNeosantara(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncNeosantara(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncNeosantara, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
