...
pip install git+ssh://git@github.com/stainless-sdks/neosantara-python.git
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/neosantara-python/issues) with questions, bugs, or suggestions.
