...
| -------- | ---- | ----------- | -------------------- |
| `apiKey` | http | HTTP Bearer | `NEOSANTARA_API_KEY` |
...
* [checkApiKeyStatus](docs/sdks/authentication/README.md#checkapikeystatus) - Check API Key status

### [chat](docs/sdks/chat/README.md)

* [chatCompletions](docs/sdks/chat/README.md#chatcompletions) - Create chat completion

### [embeddings](docs/sdks/embeddings/README.md)

* [embeddings](docs/sdks/embeddings/README.md#embeddings) - Create embeddings
...
* [reasoning](docs/sdks/reasoning/README.md#reasoning) - Reasoning completion
...
- [`authenticationCheckApiKeyStatus`](docs/sdks/authentication/README.md#checkapikeystatus) - Check API Key status
- [`chatChatCompletions`](docs/sdks/chat/README.md#chatcompletions) - Create chat completion
- [`embeddingsEmbeddings`](docs/sdks/embeddings/README.md#embeddings) - Create embeddings
...
- [`reasoningReasoning`](docs/sdks/reasoning/README.md#reasoning) - Reasoning completion
  ...
  try {
    ...
    if (error instanceof errors.NeosantaraError) {
      ...
      if (error instanceof errors.BadRequestError) {
        ...
        console.log(error.data$.infoMetadata); // components.Metadata
      }
    }
  }
}
...
* [`NeosantaraError`](./src/models/errors/neosantaraerror.ts): The base class for HTTP error responses.
  * [`AuthError`](./src/models/errors/autherror.ts): Authentication failed. Status code `401`.
  * [`RateLimitError`](./src/models/errors/ratelimiterror.ts): Rate limit exceeded. Status code `429`. *
  * [`ServerError`](./src/models/errors/servererror.ts): Internal server error. Status code `500`. *
...
* [`BadRequestError`](./src/models/errors/badrequesterror.ts): Bad request. Status code `400`. Applicable to 4 of 6 methods.*
...
const neosantara = new Neosantara({
  serverURL: "https://api.neosantara.xyz/v1",
  apiKey: process.env["NEOSANTARA_API_KEY"] ?? "",
});
...
You can also enable a default debug logger by setting an environment variable `NEOSANTARA_DEBUG` to true.
<!-- End Debugging [debug] -->
